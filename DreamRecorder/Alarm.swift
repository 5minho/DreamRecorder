...
struct WeekdayOptions: OptionSet {
    ...
    static let sat = WeekdayOptions(rawValue: 1 << 0)
    static let sun = WeekdayOptions(rawValue: 1 << 1)
    static let mon = WeekdayOptions(rawValue: 1 << 2)
    static let tue = WeekdayOptions(rawValue: 1 << 3)
    static let wed = WeekdayOptions(rawValue: 1 << 4)
    static let thu = WeekdayOptions(rawValue: 1 << 5)
    static let fri = WeekdayOptions(rawValue: 1 << 6)
